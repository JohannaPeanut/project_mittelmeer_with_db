...
var Shuffle = /*#__PURE__*/function (_ArrayManipulation) {
  ...
  function Shuffle() {
    ...
    _this = _super.call(this); // Calculate derange branches
  ...
  _createClass(Shuffle, [{
    ...
    value: function getPermutation(input) {
      ...
      this._validateInput(input, false); // Check input length
    ...
    value: function _getSimplePermutationForArray(input) {
      ...
      while (currentIndex !== 0) {
        randomIndex = Math.floor(_prngProxy["default"].next() * currentIndex);
        currentIndex -= 1; // $FlowFixMe - Destructuring swap is faster
    ...
    value: function _getDerangementForArray(input) {
      ...
      _prngProxy["default"].random(); // Initialize indexes array
      ...
      while (ni >= 2) {
        r1 = indexes[ni - 1];
        x2 = Math.floor(_prngProxy["default"].next() * (ni - 1));
        r2 = indexes[x2]; // $FlowFixMe - Destructuring swap is faster
