...
var Common = (0, _decorators.AnalyzerSingleton)(_class = (_class2 = /*#__PURE__*/function () {
  /**
   * Main input Array
   */
  ...
  _createClass(Common, [{
    ...
    value: function _calculateParams() {
      ...
      var _iterator = _createForOfIteratorHelper(this.randomArray),
          _step;
      ...
      var rvLength = this.randomArray.length,
          ...
          tempIndex; // Create PDF and CDF arrays with initial zeros

      pdf.fill(0); // Iterate over randomArray and add value to pdf

      var _iterator2 = _createForOfIteratorHelper(this.randomArray),
          _step2;
      ...
      for (var _i = 0; _i < pdf.length; _i += 1) {
        pdf[_i] /= rvLength;
        pdf_values[_i] = this._minimum + _i * values_step; // Calculate CDF

        sumOfPDF += pdf[_i];
        cdf[_i] = sumOfPDF; // Calculate mode
        ...
        if (pdf[_i] > 0.000001 && pdf[_i] < 0.999999) {
