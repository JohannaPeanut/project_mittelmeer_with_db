  ...
  _createClass(Pareto, [{
    ...
    value: function isError() {
      if (!this.xm && this.xm !== 0 || !this.alpha && this.alpha !== 0) {
        return {
          error: 'Pareto distribution: you should point "xm" (scale) and "alpha" (shape) numerical values'
        };
      }

      if (this.xm <= 0 || this.alpha <= 0) {
        return {
          error: 'Pareto distribution: parameters "xm" (scale) and "alpha" (shape) must be a positive values'
        };
      }
    ...
    value: function toString() {
      var info = ['Pareto Distribution', "Usage: unirand.pareto(".concat(this.xm, ", ").concat(this.alpha, ").random()")];
      return info.join('\n');
    }
    /**
     * Mean value
