...
var Binomial = /*#__PURE__*/function () {
  ...
  _createClass(Binomial, [{
    ...
    value: function random() {
      var res = 0,
          random = _prngProxy["default"].random(this.trials);
    ...
    value: function next() {
      ...
      for (var i = 0; i < this.trials; i += 1) {
        random = _prngProxy["default"].next();
    ...
    value: function distribution(n) {
      var binomialArray = [],
          random = _prngProxy["default"].random(n * this.trials),
          res;
    ...
    value: function isError() {
      if (!this.trials || !this.successProb && this.successProb !== 0) {
        return {
          error: 'Binomial distribution: you should point parameter "n" like a positive integer and parameter "p" like a numerical value'
        };
      }

      if (this.trials <= 0) {
        return {
          error: 'Binomial distribution: parameter "n" must be positive integer'
        };
      }

      if (this.successProb < 0 || this.successProb > 1) {
        return {
          error: 'Binomial distribution: parameter "p" (probability of success) must be 0 <= p <= 1'
        };
      }
    ...
    value: function toString() {
      var info = ['Binomial Distribution', "Usage: unirand.binomial(".concat(this.trials, ", ").concat(this.successProb, ").random()")];
      return info.join('\n');
    }
    /**
     * Mean value
