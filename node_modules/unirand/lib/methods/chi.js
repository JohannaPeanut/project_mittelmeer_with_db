...
var Chi = /*#__PURE__*/function () {
  ...
  _createClass(Chi, [{
    ...
    value: function isError() {
      if (!this.degrees) {
        return {
          error: 'Chi distribution: you should point parameter "k" positive numerical value'
        };
      }

      if (this.degrees <= 0) {
        return {
          error: 'Chi distribution: parameter "k" must be positive integer'
        };
      }
    ...
    value: function toString() {
      var info = ['Chi Distribution', "Usage: unirand.chi(".concat(this.degrees, ").random()")];
      return info.join('\n');
    }
    /**
     * Mean value
