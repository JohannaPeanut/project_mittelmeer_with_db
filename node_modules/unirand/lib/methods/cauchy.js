...
var Cauchy = /*#__PURE__*/function () {
  ...
  _createClass(Cauchy, [{
    ...
    value: function random() {
      var randomTan = Math.tan(Math.PI * (_prngProxy["default"].random() - 0.5));

      while (Math.abs(randomTan) > TAN_LIMIT) {
        randomTan = Math.tan(Math.PI * (_prngProxy["default"].next() - 0.5));
      }
    ...
    key: "next",
    value: function next() {
      var randomTan = Math.tan(Math.PI * (_prngProxy["default"].next() - 0.5));
    ...
    value: function isError() {
      if (!this.location || !this.scale && this.scale !== 0) {
        return {
          error: 'Cauchy distribution: you should point "x" and "gamma" numerical values'
        };
      }

      if (this.scale <= 0) {
        return {
          error: 'Cauchy distribution: parameter "gamma" must be positive'
        };
      }
    ...
    value: function toString() {
      var info = ['Cauchy Distribution', "Usage: unirand.cauchy(".concat(this.location, ", ").concat(this.scale, ").random()")];
      return info.join('\n');
    }
    /**
