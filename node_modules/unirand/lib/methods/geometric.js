...
var Geometric = /*#__PURE__*/function () {
  ...
  _createClass(Geometric, [{
    ...
    value: function random() {
      var res = 1,
          random = _prngProxy["default"].random();
    ...
    value: function isError() {
      if (!this.successProb && this.successProb !== 0) {
        return {
          error: 'Geometric distribution: you should specify parameter "p" with numerical value'
        };
      }

      if (this.successProb < 0 || this.successProb > 1) {
        return {
          error: 'Geometric distribution: parameter "p" (probability of success) must be 0 <= p <= 1'
        };
      }
    ...
    value: function toString() {
      var info = ['Geometric Distribution', "Usage: unirand.geometric(".concat(this.successProb, ").random()")];
      return info.join('\n');
    }
    /**
     * Mean value
