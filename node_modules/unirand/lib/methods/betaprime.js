...
var BetaPrime = /*#__PURE__*/function () {
  ...
  _createClass(BetaPrime, [{
    ...
    value: function isError() {
      if (!this.alpha || !this.beta) {
        return {
          error: 'Beta Prime distribution: you should point "alpha" and "beta" positive numerical values'
        };
      }

      if (this.alpha <= 0) {
        return {
          error: 'Beta Prime distribution: Parameter "alpha" must be positive'
        };
      }

      if (this.beta <= 0) {
        return {
          error: 'Beta Prime distribution: Parameter "beta" must be positive'
        };
      }
    ...
    value: function toString() {
      var info = ['Beta Prime Distribution', "Usage: unirand.betaprime(".concat(this.alpha, ", ").concat(this.beta, ").random()")];
      return info.join('\n');
    }
    /**
     * Mean value
