...
var Triangular = /*#__PURE__*/function () {
  ...
  _createClass(Triangular, [{
    ...
    value: function isError() {
      if (!this.a && this.a !== 0 || !this.b && this.b !== 0 || !this.c && this.c !== 0) {
        return {
          error: 'Triangular distribution: you should point "a", "b" and "c" numerical values'
        };
      }

      if (this.b <= this.a) {
        return {
          error: 'Triangular distribution: parameters "b" must be greater then parameter "a"'
        };
      }

      if (this.c < this.a || this.c > this.b) {
        return {
          error: 'Triangular distribution: parameters "c" must be greater then or equal to parameter "a" and lower then or equal to parameter "b"'
        };
      }
    ...
    value: function toString() {
      var info = ['Triangular Distribution', "Usage: unirand.triangular(".concat(this.a, ", ").concat(this.b, ", ").concat(this.c, ").random()")];
      return info.join('\n');
    }
    /**
     * Mean value
