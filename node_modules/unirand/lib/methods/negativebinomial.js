...
var NegativeBinomial = /*#__PURE__*/function () {
  ...
  _createClass(NegativeBinomial, [{
    ...
    value: function isError() {
      if (!this.numberSuccess || !this.successProb && this.successProb !== 0) {
        return {
          error: 'Negative Binomial distribution: you should point "r" and "p" parameters with numerical values'
        };
      }

      if (this.numberSuccess <= 0) {
        return {
          error: 'Negative Binomial distribution: parameter "r" must be positive integer'
        };
      }

      if (this.successProb < 0 || this.successProb > 1) {
        return {
          error: 'Negative Binomial distribution: parameter "p" (probability of success) must be 0 <= p <= 1'
        };
      }
    ...
    value: function toString() {
      var info = ['Negative Binomial Distribution', "Usage: unirand.negativebinomial(".concat(this.numberSuccess, ", ").concat(this.successProb, ").random()")];
      return info.join('\n');
    }
    /**
     * Mean value
