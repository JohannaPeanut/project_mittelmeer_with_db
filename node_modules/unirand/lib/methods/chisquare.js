...
var ChiSquare = /*#__PURE__*/function () {
  ...
  _createClass(ChiSquare, [{
    ...
    value: function random() {
      var res = 0,
          random = this.normal.distribution(this.degrees);

      for (var i = 0; i < this.degrees; i += 1) {
    ...
    value: function distribution(n) {
      var chiSquareArray = [],
          res,
          random = this.normal.distribution(n * this.degrees);

      for (var i = 0; i < n; i += 1) {
        res = 0;

        for (var j = 0; j < this.degrees; j += 1) {
    ...
    value: function isError() {
      if (!this.degrees) {
        return {
          error: 'Chi Square distribution: you should point parameter "k" positive numerical value'
        };
      }

      if (this.degrees <= 0) {
        return {
          error: 'Chi Square distribution: parameter "k" must be positive integer'
        };
      }
    ...
    value: function toString() {
      var info = ['Chi Square Distribution', "Usage: unirand.chisquare(".concat(this.degrees, ").random()")];
      return info.join('\n');
    }
    /**
     * Mean value
