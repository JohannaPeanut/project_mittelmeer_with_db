...
var Normal = /*#__PURE__*/function () {
  ...
  _createClass(Normal, [{
    ...
    value: function _random() {
      ...
      do {
        U1 = 2 * _prngProxy["default"].next() - 1;
        U2 = 2 * _prngProxy["default"].next() - 1;
    ...
    value: function isError() {
      if (!this.mu && this.mu !== 0 || !this.sigma && this.sigma !== 0) {
        return {
          error: 'Normal distribution: you should point "mu" and "sigma" numerical values'
        };
      }

      if (this.sigma <= 0) {
        return {
          error: 'Normal distribution: parameter "sigma" must be a positive value'
        };
      }
    ...
    value: function toString() {
      var info = ['Normal (Gaussian) Distribution', "Usage: unirand.normal(".concat(this.mu, ", ").concat(this.sigma, ").random()")];
      return info.join('\n');
    }
    /**
     * Mean value
