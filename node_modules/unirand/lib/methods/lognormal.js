  ...
  _createClass(Lognormal, [{
    ...
    value: function isError() {
      if (!this.mu && this.mu !== 0 || !this.sigma) {
        return {
          error: 'Lognormal distribution: you should point parameters "mu" and "sigma" with numerical values'
        };
      }

      if (this.sigma <= 0) {
        return {
          error: 'Lognormal distribution: parameter "sigma" must be a positive number'
        };
      }
    ...
    value: function toString() {
      var info = ['Lognormal Distribution', "Usage: unirand.lognormal(".concat(this.mu, ", ").concat(this.sigma, ").random()")];
      return info.join('\n');
    }
    /**
     * Mean value
