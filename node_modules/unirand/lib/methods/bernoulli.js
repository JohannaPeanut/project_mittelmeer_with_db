...
var Bernoulli = /*#__PURE__*/function () {
  ...
  _createClass(Bernoulli, [{
    ...
    value: function isError() {
      if (!this.p && this.p !== 0) {
        return {
          error: 'Bernoulli distribution: you should point "p" numerical value'
        };
      }

      if (this.p < 0 || this.p > 1) {
        return {
          error: 'Bernoulli distribution: Parameter "p" must be from 0 to 1 inclusive'
        };
      }
    ...
    value: function toString() {
      var info = ['Bernoulli Distribution', "Usage: unirand.bernoulli(".concat(this.p, ").random()")];
      return info.join('\n');
    }
    /**
     * Mean value
