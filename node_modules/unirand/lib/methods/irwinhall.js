...
var IrwinHall = /*#__PURE__*/function () {
  ...
  _createClass(IrwinHall, [{
    ...
    value: function isError() {
      if (!this.n || this.n < 1) {
        return {
          error: 'Irwin-Hall distribution: you should point "n" positive integer value'
        };
      }
    ...
    value: function toString() {
      var info = ['Irwin-Hall Distribution', "Usage: unirand.irwinhall(".concat(this.n, ").random()")];
      return info.join('\n');
    }
    /**
     * Mean value
