...
var Erlang = /*#__PURE__*/function () {
  ...
  _createClass(Erlang, [{
    ...
    value: function random() {
      var p = 1,
          random = _prngProxy["default"].random(this.shape);
    ...
    value: function distribution(n) {
      var erlangArray = [],
          p,
          random = _prngProxy["default"].random(n * this.shape);
    ...
    value: function isError() {
      if (!this.scale || !this.shape) {
        return {
          error: 'Erlang distribution: you should point "mu" and "k" positive numerical values'
        };
      }

      if (this.shape <= 0) {
        return {
          error: 'Erlang distribution: parameter "k" must be a positive integer'
        };
      }

      if (this.scale <= 0) {
        return {
          error: 'Erlang distribution: parameter "mu" must be positive'
        };
      }
    ...
    value: function toString() {
      var info = ['Erlang Distribution', "Usage: unirand.erlang(".concat(this.shape, ", ").concat(this.scale, ").random()")];
      return info.join('\n');
    }
    /**
     * Mean value
