...
var ParkMillerPRNG = /*#__PURE__*/function (_BasicPRNG) {
  _inherits(ParkMillerPRNG, _BasicPRNG);

  var _super = _createSuper(ParkMillerPRNG);

  // state after setting seed
  function ParkMillerPRNG() {
    var _this;

    _classCallCheck(this, ParkMillerPRNG);
  ...
  _createClass(ParkMillerPRNG, [{
    ...
    value: function _nextInt() {
      var div = Math.floor(this._x / this._Q);
      var rem = this._x % this._Q;
      var res = rem * this._A - div * this._R;
  ...
  return ParkMillerPRNG;
}(_BasicPRNG2["default"]);

var _default = ParkMillerPRNG;
