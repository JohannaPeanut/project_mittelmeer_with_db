...
var WORD_C = 6988;
var WORD_D = 9689;
var NEGATIVE_WORD_A = WORD_D - WORD_A; // need it for simplify calculation

var NEGATIVE_WORD_B = WORD_D - WORD_B; // need it for simplify calculation

var NEGATIVE_WORD_C = WORD_D - WORD_C; // need it for simplify calculation

var RECALCULATE_FREQ = 65536;

var Gfsr4PRNG = /*#__PURE__*/function (_BasicPRNG) {
  _inherits(Gfsr4PRNG, _BasicPRNG);

  var _super = _createSuper(Gfsr4PRNG);
  ...
  function Gfsr4PRNG() {
    ...
    _classCallCheck(this, Gfsr4PRNG);
    ...
    _this._pointersA = _this._generate_shifted_pointers(NEGATIVE_WORD_A);
    _this._pointersB = _this._generate_shifted_pointers(NEGATIVE_WORD_B);
    _this._pointersC = _this._generate_shifted_pointers(NEGATIVE_WORD_C);
  ...
  _createClass(Gfsr4PRNG, [{
    ...
    value: function _nextInt() {
      var res;
      this._words[this._pointer] = this._words[this._pointersA[this._pointer]] ^ this._words[this._pointersB[this._pointer]] ^ this._words[this._pointersC[this._pointer]] ^ this._words[this._pointer];
