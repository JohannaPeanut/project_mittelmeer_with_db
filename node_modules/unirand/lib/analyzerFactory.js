...
var AnalyzerMethodsMapper = require('./analyzer');
...
function AnalyzerFactory(randomArray, options) {
  ...
  Object.keys(AnalyzerMethodsMapper).forEach(function (mKey) {
    var methodsClass = new Promise(function (resolve, reject) {
      setTimeout(function () {
        /**
        ...
        if (!Array.isArray(_this.randomArray)) {
          ...
          resolve(AnalyzerMethodsMapper[mKey].getInstance(_this.randomArray, options));
        }
      }, 0);
    }); // Write properties and function to object for sync checking type of method

    for (var prop in AnalyzerMethodsMapper[mKey].publicMethods) {
      _this._methodsTypes[prop] = 'property';
    }

    for (var _prop in AnalyzerMethodsMapper[mKey].publicFunctions) {
        ...
        Object.keys(methodsClass.constructor.publicMethods).forEach(function (classMethod) {
          ...
          Object.defineProperty(_this, classMethod, {
            ...
            get: function get() {
              if (typeof methodsClass[classMethod] === 'function') {
                return function () {
                  return methodsClass[classMethod].bind(methodsClass).apply(void 0, arguments);
                };
              }
        ...
        Object.keys(methodsClass.constructor.publicFunctions).forEach(function (classFunction) {
          ...
          Object.defineProperty(_this, classFunction, {
            ...
            value: function value() {
              return methodsClass[classFunction].bind(methodsClass).apply(void 0, arguments);
            }
          });
        });
      }
